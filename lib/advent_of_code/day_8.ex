defmodule AdventOfCode.Day8 do
  @moduledoc """
  # Advent of Code, Day 8: Two-Factory Authentication
  ...
  @doc """
  Count the active pixels for the instructions
  """
  @spec count_pixels(screen) :: integer
  ...
  @spec read_pixel_at(screen, {integer, integer}) :: String.t
